            ...
            blocks: [
                {
                    ...
                    content: (
                        <div className='space-y-6'>
                            <ContentParagraph>
                                আপনি যদি শুধু ভালো কোড করতে জানেন, তবেই কি আপনি
                                একজন{' '}
                                <strong className='text-foreground'>
                                    Software Engineer ?
                                </strong>{'    '}
                                অনেকের হয়তো মনে হতে পারে,ভালো কোড লেখতে পারলেই
                                হয়তো সফটওয়ার ইঞ্জিনিয়ার হয়ে যাওয়া যায়। অবশ্য
                                আমাদের দেশে কিছুটা ওইরকমই মনে করা হয়। তবে আপনি
                                যদি সফটওয়ার ইঞ্জিনিয়ারিং কে একটা বিশাল বিল্ডিং
                                এর মতো ভাবেন তাহলে কোড লেখাটা হল সেই বিল্ডিং এর
                                ইটের মতো। আপনি যদি শুধু ইট গেঁথেই একটা বিল্ডিং
                                তৈরি করেন তবে হয়তো আপনি কোনমতো একটা এক তলা
                                বিল্ডিং বানাতে পারবেন, কিন্তু কখনওই সেই বিশাল
                                বিল্ডিং বানাতে পারবেন না। বিশাল বিল্ডিং বানানোর
                                জন্য দরকার হয় আর্কিটেক্ট এর। ঠিক তেমনি আপনি যদি
                                শুধু ভালো কোড লেখতে পারেন, তবে আপনি একজন সাধারণ
                                ডেভেলপার, সফটওয়ার ইঞ্জিনিয়ার নন । কারণ আপনি
                                আর্কিটেক্ট জানেন না ।
                            </ContentParagraph>

                            <ContentParagraph>
                                আর তাই যদি বড় এপ্লিকেশন বানাতে চান তবে আপনাকে
                                সিস্টেম ডিজাইন শিখতে হবে। আপনাকে জানতে হবে কি
                                ভাবে ডেটাবেস ডিজাইন করতে হয় , কি ভাবে লোড
                                ব্যালেন্সার ব্যবহার করতে হয়, কি ভাবে ক্যাশিং
                                ব্যবহার করতে হয়, কি ভাবে স্কেলিং করতে হয়, কি
                                ভাবে সিকিউরিটি ইমপ্লিমেন্ট করতে হয় ইত্যাদি। আর
                                এই জিনিশগুলো মাথায় রেখে এপ্লিকেশন ডিজাইন করাই
                                মূলত সিস্টেম ডিজাইন করা ।
                            </ContentParagraph>
                            <ContentParagraph>
                                <strong className='text-foreground'>
                                    তাই নিজেকে একজন সফটওয়ার ইঞ্জিনিয়ার হিসেবে
                                    গড়তে চাইলে সিস্টেম ডিজাইন শিখতে হবেই।
                                </strong>
                            </ContentParagraph>
                            <FeatureGrid>
        ...
        },
        {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    content: (
                        <ContentParagraph>
                            শুরুতে <strong>Vertical Scaling</strong> সহজ মনে
                            হলেও, বড় স্কেলে <strong>Horizontal Scaling</strong>
                            -ই হলো আসল সমাধান। কেননা বিশ্বের সবচাইতে বড়
                            কম্পিউটারেরও কিন্তু হার্ডওয়ার লিমিট রয়েছে। তাছাড়া
                            সিঙ্গেল পয়েন্ট অফ ফেইলারের ব্যাপারও আছে। আমরা সামনের
                            দিনগুলোতে এগুলো বিস্তারিত জানবো ।
                        </ContentParagraph>
                    ),
                },
            ],
